...
public class DJIDemoApplication extends Application
{
    ...
    public void onCreate()
    {
        ...
        // When starting SDK services, an instance of interface DJISDKManager.DJISDKManagerCallback will be used to listen to the SDK Registration result and the product changing.
